...
use Closure;
use IlluminateNew\Contracts\Mail\Factory;
use IlluminateNew\Contracts\Mail\Mailable;
use IlluminateNew\Contracts\Mail\Mailer;
use IlluminateNew\Contracts\Mail\MailQueue;
use IlluminateNew\Contracts\Queue\ShouldQueue;
...
class MailFake implements Factory, Mailer, MailQueue
{
     ...
     *
     * @param  mixed  $users
     * @return \IlluminateNew\Mail\PendingMail
     */
     ...
     *
     * @param  \IlluminateNew\Contracts\Mail\Mailable|string|array  $view
     * @param  array  $data
