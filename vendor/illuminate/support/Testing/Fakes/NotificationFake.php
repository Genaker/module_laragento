...
use Closure;
use Exception;
use IlluminateNew\Contracts\Notifications\Dispatcher as NotificationDispatcher;
use IlluminateNew\Contracts\Notifications\Factory as NotificationFactory;
use IlluminateNew\Contracts\Translation\HasLocalePreference;
...
class NotificationFake implements NotificationDispatcher, NotificationFactory
{
     ...
     *
     * @param  \IlluminateNew\Support\Collection|array|mixed  $notifiables
