...
/**
 * @method static \IlluminateNew\Contracts\Routing\UrlGenerator setRootControllerNamespace(string $rootNamespace)
 * @method static bool hasValidSignature(\IlluminateNew\Http\Request $request, bool $absolute = true)
 ...
 *
 * @see \IlluminateNew\Routing\UrlGenerator
 */
