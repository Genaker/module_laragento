...
use IlluminateNew\Queue\Worker;
use IlluminateNew\Support\Testing\Fakes\QueueFake;

/**
 * @method static \IlluminateNew\Contracts\Queue\Job|null pop(string $queue = null)
 * @method static \IlluminateNew\Contracts\Queue\Queue setConnectionName(string $name)
 ...
 *
 * @see \IlluminateNew\Queue\QueueManager
 * @see \IlluminateNew\Queue\Queue
 */
class Queue extends Facade
{
     ...
     *
     * @return \IlluminateNew\Support\Testing\Fakes\QueueFake
     */
