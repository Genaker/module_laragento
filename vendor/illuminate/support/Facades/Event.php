...
use IlluminateNew\Support\Testing\Fakes\EventFake;

/**
 * @method static \Closure createClassListener(string $listener, bool $wildcard = false)
 * @method static \Closure makeListener(\Closure|string $listener, bool $wildcard = false)
 * @method static \IlluminateNew\Events\Dispatcher setQueueResolver(callable $resolver)
 ...
 *
 * @see \IlluminateNew\Events\Dispatcher
 */
class Event extends Facade
{
     ...
     * @return \IlluminateNew\Support\Testing\Fakes\EventFake
     */
