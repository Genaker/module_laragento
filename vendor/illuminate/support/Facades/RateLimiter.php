...
/**
 * @method static \IlluminateNew\Cache\RateLimiter for(string $name, \Closure $callback)
 ...
 *
 * @see \IlluminateNew\Cache\RateLimiter
 */
class RateLimiter extends Facade
{
    ...
    {
        return 'IlluminateNew\Cache\RateLimiter';
    }
}
