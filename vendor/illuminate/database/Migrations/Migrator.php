...
namespace IlluminateNew\Database\Migrations;

use Doctrine\DBAL\Schema\SchemaException;
use IlluminateNew\Contracts\Events\Dispatcher;
use IlluminateNew\Database\ConnectionResolverInterface as Resolver;
use IlluminateNew\Database\Events\MigrationEnded;
use IlluminateNew\Database\Events\MigrationsEnded;
use IlluminateNew\Database\Events\MigrationsStarted;
use IlluminateNew\Database\Events\MigrationStarted;
use IlluminateNew\Database\Events\NoPendingMigrations;
...
class Migrator
{
     ...
     *
     * @var \IlluminateNew\Database\Migrations\MigrationRepositoryInterface
     */
     ...
     *
     * @var \IlluminateNew\Filesystem\Filesystem
     */
    protected $files;
     ...
     *
     * @param  \IlluminateNew\Database\Migrations\MigrationRepositoryInterface  $repository
     * @param  \IlluminateNew\Database\ConnectionResolverInterface  $resolver
     * @param  \IlluminateNew\Filesystem\Filesystem  $files
     * @param  \IlluminateNew\Contracts\Events\Dispatcher|null  $dispatcher
     * @return void
     */
     ...
     *
     * @return \IlluminateNew\Database\Migrations\MigrationRepositoryInterface
     */
     ...
     *
     * @return \IlluminateNew\Filesystem\Filesystem
     */
     ...
     *
     * @param  \IlluminateNew\Contracts\Database\Events\MigrationEvent  $event
     * @return void
     */
