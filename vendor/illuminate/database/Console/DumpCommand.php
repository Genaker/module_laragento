...
namespace IlluminateNew\Database\Console;

use IlluminateNew\Console\Command;
use IlluminateNew\Contracts\Events\Dispatcher;
use IlluminateNew\Database\Connection;
use IlluminateNew\Database\ConnectionResolverInterface;
use IlluminateNew\Database\Events\SchemaDumped;
use IlluminateNew\Filesystem\Filesystem;
use IlluminateNew\Support\Facades\Config;
...
class DumpCommand extends Command
{
     ...
     *
     * @param  \IlluminateNew\Database\ConnectionResolverInterface  $connections
