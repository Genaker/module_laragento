...
use ArrayAccess;
use IlluminateNew\Contracts\Broadcasting\HasBroadcastChannel;
use IlluminateNew\Contracts\Queue\QueueableCollection;
use IlluminateNew\Contracts\Queue\QueueableEntity;
use IlluminateNew\Contracts\Routing\UrlRoutable;
use IlluminateNew\Contracts\Support\Arrayable;
use IlluminateNew\Contracts\Support\CanBeEscapedWhenCastToString;
use IlluminateNew\Contracts\Support\Jsonable;
use IlluminateNew\Database\ConnectionResolverInterface as Resolver;
use IlluminateNew\Database\Eloquent\Collection as EloquentCollection;
use IlluminateNew\Database\Eloquent\Relations\BelongsToMany;
use IlluminateNew\Database\Eloquent\Relations\Concerns\AsPivot;
use IlluminateNew\Database\Eloquent\Relations\HasManyThrough;
use IlluminateNew\Database\Eloquent\Relations\Pivot;
use IlluminateNew\Support\Arr;
use IlluminateNew\Support\Collection as BaseCollection;
...
abstract class Model implements Arrayable, ArrayAccess, CanBeEscapedWhenCastToString, HasBroadcastChannel, Jsonable, JsonSerializable, QueueableEntity, UrlRoutable
{
     ...
     *
     * @var \IlluminateNew\Database\ConnectionResolverInterface
     */
     ...
     *
     * @var \IlluminateNew\Contracts\Events\Dispatcher
     */
     ...
     * @return $this
     *
     * @throws \IlluminateNew\Database\Eloquent\MassAssignmentException
     */
     ...
     *
     * @param  \IlluminateNew\Support\Collection|array|int|string  $ids
     * @return int
     */
     ...
     *
     * @return \IlluminateNew\Database\Eloquent\Builder|static
     */
     ...
     * @return \IlluminateNew\Database\Eloquent\Relations\Pivot
     */
     ...
     * @return string
     *
     * @throws \IlluminateNew\Database\Eloquent\JsonEncodingException
     */
     ...
     *
     * @param  \IlluminateNew\Database\Eloquent\Model|null  $model
     * @return bool
     */
     ...
     *
     * @return \IlluminateNew\Database\Connection
     */
     ...
     *
     * @return \IlluminateNew\Database\ConnectionResolverInterface
     */
     ...
     *
     * @param  \IlluminateNew\Database\ConnectionResolverInterface  $resolver
     * @return void
     */
     ...
     * @return \IlluminateNew\Database\Eloquent\Model|null
     */
