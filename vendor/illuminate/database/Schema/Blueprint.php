...
use IlluminateNew\Database\Schema\Grammars\Grammar;
use IlluminateNew\Database\SQLiteConnection;
use IlluminateNew\Support\Fluent;
...
class Blueprint
{
     ...
     *
     * @var \IlluminateNew\Database\Schema\ColumnDefinition[]
     */
    protected $columns = [];
     ...
     *
     * @var \IlluminateNew\Support\Fluent[]
     */
    protected $commands = [];
     ...
     *
     * @return \IlluminateNew\Support\Fluent
     */
     ...
     *
     * @param  string  $column
     * @return \IlluminateNew\Database\Schema\ColumnDefinition
     */
     ...
     *
     * @param  string  $column
     * @return \IlluminateNew\Database\Schema\ForeignIdColumnDefinition
     */
     ...
     *
     * @param  \IlluminateNew\Database\Schema\ColumnDefinition  $definition
     * @return \IlluminateNew\Database\Schema\ColumnDefinition
     */
