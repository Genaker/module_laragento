...
/**
 * Class CatalogProductIndexPriceBundleOptTmp
 * 
 ...
 */
class CatalogProductIndexPriceBundleOptTmp extends Model
{
	protected $table = 'catalog_product_index_price_bundle_opt_tmp';
