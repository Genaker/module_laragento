...
/**
 * Class ReportViewedProductAggregatedYearly
 * 
 * @property int $id
 ...
 */
class ReportViewedProductAggregatedYearly extends Model
{
	protected $table = 'report_viewed_product_aggregated_yearly';
